...
import springboot.with.security.repository.RoleRepository;
import springboot.with.security.repository.UserRepository;
import springboot.with.security.service.security.jwt.JwtUtils;
...
import springboot.with.security.service.security.jwt.AuthEntryPointJwt;
...
public class AuthorizationService {
    ...
    public ResponseEntity<MessageResponse> registerUser(@Valid SignupRequest signUpRequest) {
        ...
        User user = new User(signUpRequest.getUsername(),
                ...
                encoder.encode(signUpRequest.getPassword()), signUpRequest.getCoinBalance(), signUpRequest.getSubscribeToNewsletter(), signUpRequest.getProfilePicture());
